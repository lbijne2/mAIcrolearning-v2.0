...
export const MicrophoneIcon = ({ size = 16 }: { size?: number }) => (
  ...
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M8 1C6.61929 1 5.5 2.11929 5.5 3.5V8C5.5 9.38071 6.61929 10.5 8 10.5C9.38071 10.5 10.5 9.38071 10.5 8V3.5C10.5 2.11929 9.38071 1 8 1ZM4 3.5C4 1.567 5.567 0 7.5 0H8.5C10.433 0 12 1.567 12 3.5V8C12 9.933 10.433 11.5 8.5 11.5H7.5C5.567 11.5 4 9.933 4 8V3.5ZM8 13.5C10.8995 13.5 13.25 11.1495 13.25 8.25H14.75C14.75 11.9848 11.9848 14.75 8.25 14.75V16H7V14.75C3.26521 14.75 0.5 11.9848 0.5 8.25H2C2 11.1495 4.35051 13.5 7.25 13.5H8Z"
      fill="currentColor"
    />
  </svg>
);
